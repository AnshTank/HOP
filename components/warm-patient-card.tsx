...
export function WarmPatientCard({
  ...
  const [mood, setMood] = useState<
    "calm" | "anxious" | "pain" | "neutral" | null
  >(null);
    ...
    >
      ...
      <CardContent className="p-6 flex flex-col h-full">
            ...
            <div className="flex items-center gap-3 mb-1">
              ...
              <div className="flex items-center gap-1">
                <div
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    const moods: ("calm" | "anxious" | "pain" | "neutral")[] = [
                      "calm",
                      "anxious",
                      "pain",
                      "neutral",
        ...
        <div className="flex flex-wrap gap-2 mb-4 min-h-[32px]">
          {patient.hasAlerts && (
            <Badge className="bg-red-100 text-red-800 border-red-300 rounded-xl animate-pulse">
              🚨 Alert
            </Badge>
          )}

          {patient.requiresFollowUp && (
            <Badge className="bg-blue-100 text-blue-800 border-blue-300 rounded-xl">
              📅 Follow-up
            </Badge>
          )}
          ...
          {patient.requiresContactPrecautions && (
            <Badge className="bg-purple-100 text-purple-800 border-purple-300 rounded-xl">
              🧤 Contact Precautions
            </Badge>
          )}
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-4 flex-grow">
          ...
          <div className="bg-white/60 rounded-2xl p-3 border border-gray-100">
            ...
            <div className="text-sm font-semibold text-gray-800">
              {getTimeAgo(patient.lastVitalsTime)}
            </div>
          </div>
        </div>
